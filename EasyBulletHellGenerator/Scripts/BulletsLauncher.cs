...
namespace EasyBulletHellGenerator
{
    public class BulletsLauncher : MonoBehaviour
    {
        ...
        public BulletsManager GenerateBulletHell(BulletPattern bulletpattern)
        {
            ...
            s.InitialBulletStatus(bulletpattern.isMissile, bulletpattern.speed, bulletpattern.acceleration, bulletpattern.existTime, bulletpattern.objDirection); // íeÇÃãììÆê›íË
